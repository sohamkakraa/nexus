...
export const metadata: Metadata = {
  title: "Security",
  description: "The Nexus desktop trust model, credential boundary, IPC validation, permissions, release gates, and vulnerability reporting.",
    ...
    <>
      ...
      <main className={styles.main}>
        <header className={styles.hero}>
          ...
          <p>Nexus narrows privileged desktop capabilities, asks before consequential actions, and keeps provider credentials in the operating system credential store.</p>
        </header>
        <div className={styles.content}>
          <article className={styles.article}>
            <section id="status">
              <h2>Current assurance</h2>
              <div className={styles.note}><strong>Source beta; not independently audited</strong><p>The controls below are implemented and tested in the repository. They are not a claim of formal verification, third-party penetration testing, or a currently published signed installer.</p></div>
            </section>
            <section id="keys">
              <h2>Credential boundary</h2>
              <p>OpenAI and Anthropic keys are stored and retrieved with <code>keytar</code> through macOS Keychain, Windows Credential Manager, or a Secret Service-compatible Linux keyring. They are excluded from renderer snapshots, diagnostics, data exports, local MCP environments, and approved command environments.</p>
            ...
            <section id="releases">
              ...
              <p>The signed-tag workflow builds on native macOS, Windows, and Linux runners, validates the release manifest, and produces SHA-256 checksums, an SBOM, and provenance where available.</p>
              <p>macOS releases require Developer ID signing and notarization; Windows releases require valid Authenticode. Unsigned candidates remain workflow artifacts and are not published automatically.</p>
            </section>
            <section id="report">
